    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <div className="glass-card p-8 mb-8">
        ...
        <p className="mb-4" style={{ color: 'var(--skin-text-secondary)' }}>
          The agent assessment is conducted via MCP (Model Context Protocol). Your AI agent connects to our
          MCP server and completes 25 structured questions across three domains:
        </p>
